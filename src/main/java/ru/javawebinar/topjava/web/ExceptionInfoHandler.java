...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        if (e.getCause() instanceof ConstraintViolationException) {
            ...
            String msg = messageSource.getMessage("validation." + constraintName, null, constraintName, LocaleContextHolder.getLocale());
            return logAndGetErrorInfo(req, e, true, VALIDATION_ERROR, List.of(msg));
        }
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, List<String> errors) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType, errors == null ? List.of(rootCause.getMessage()) : errors);
    }
}